...
/*   Updated: 2025/05/07 14:12:36 by gansari          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * right-side command in a pipe (cmd2 in "cmd1 | cmd2"). It performs two main tasks:
 ...
 * of the pipe, effectively capturing the output of the left command as its input.
...
/**
 * execute_right_cmd - Creates and configures child process for the right command
 *
 ...
 *    - Delegates to child_right_cmd() to set up redirection and execute the command
