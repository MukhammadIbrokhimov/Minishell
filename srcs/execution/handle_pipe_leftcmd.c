...
/*   Updated: 2025/05/07 14:02:45 by gansari          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * left-side command in a pipe (cmd1 in "cmd1 | cmd2"). It performs two main tasks:
 ...
 *    - Delegates to child_left_cmd() to set up redirection and execute the command
